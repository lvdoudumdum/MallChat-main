...
public class WxPortalController {
    ...
    public RedirectView callBack(@RequestParam String code) {
        String authorize = String.format(wxService.getWxMpConfigStorage().getAppId(), URLEncoder.encode(code+"/wx/protal/public"));
        System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"+authorize);
        try {
        ...
        //扫码后回调地址
        redirectView.setUrl("https://mp.weixin.qq.com/s/n6a_vpoX5cFIOLoFPeOdMA");
        return redirectView;
    }
